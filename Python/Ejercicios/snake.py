...
def posValida(posVector):
    ...
    if (nuevaCabeza[0]>=0 and nuevaCabeza[0]<8 #que la posición X este dentro del tablero
        and nuevaCabeza[1]>=0 and nuevaCabeza[1]<8 #que la posición Y este dentro del tablero
